...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='payment',
            name='income',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='projects.income'),
        ),
        migrations.AddField(
            model_name='payment',
            name='updated_by',
        ...
        migrations.AddField(
            model_name='location',
            name='country',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='projects.country'),
        ),
        migrations.AddField(
            model_name='location',
            name='project',
